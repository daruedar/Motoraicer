...
<body class="ps-static  cms-index-index cms-home" style="position: relative; min-height: 100%; top: 0px;">   
	...
	<!-- Baner  new  -->			<div class="col-main col-xs-12 col-sm-9">
									    <div class="padding-s">
											...
											<div class="page-title category-title"><h1>CILINDROS</h1></div>
												    <div class="category-products">
							                            <ul class="products-grid row first odd">
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Cilindro con piston estandar para moto Yamaha modelo: RX-115" class="product-image">
											                            <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2527.png" alt="Cilindro con piston estandar para moto Yamaha modelo: RX-115">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto Yamaha modelo: RX-115">
												                            Cilindro con piston estandar para moto Yamaha RX-115</a></h2>
												    
											                            <h3 class="product-sku">REF: <span>DH-18K 45</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$180.000</span>
												                            </p>

												                            <p class="special-price">
													                            <span class="price-label">Precio Especial</span>
													                            <span class="price" id="product-price-1802">$140.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="370">
								                            ...
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Cilindro con piston estandar para moto Yamaha modelo: BWS-100" class="product-image">
											                             <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2528.png" alt="Cilindro con piston estandar para moto Yamaha modelo: BWS-100">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto Yamaha modelo: BWS-100">
												                             Cilindro con piston estandar para moto Yamaha BWS-100</a></h2>
											                            <h3 class="product-sku">REF: <span>DH-18K 46</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$130.000</span>
												                            </p>

												                            <p class="special-price">
													                            <span class="price-label">Precio Especial</span>
													                            <span class="price" id="product-price-1802">$100.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="371">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
                                    							<div class="wrapper-hover">
                                    								<a href="" title="Cilindro con piston estandar para moto modelo: PULSAR-135" class="product-image">
                                    								    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2529.png" alt="Cilindro con piston estandar para moto modelo: PULSAR-135"></a>
                                    								<div class="product-shop">
                                    									<h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: PULSAR-135">Cilindro con piston estandar para moto modelo: PULSAR-135</a></h2>
                                    									<h3 class="product-sku">REF: <span>DH-18K 47</span></h3>
                                    				                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$120.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$90.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            							    <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="372">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row even">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto modelo: PULSAR-180" class="product-image">
								                                    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2530.png" alt="Cilindro con piston estandar para moto modelo: PULSAR-180"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: PULSAR-180">Cilindro con piston estandar para moto modelo: PULSAR-180</a></h2>
									                                    <h3 class="product-sku">REF: <span>DH-18K 48</span></h3>
									                                     <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$190.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$130.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="373">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                            								    <span><span>Comprar</span></span></button>
                                            								    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
												            ...
												            <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto Suzuki modelo: AX-100" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2531.png" alt="Cilindro con piston estandar para moto Suzuki modelo: AX-100"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto Suzuki modelo: AX-100">Cilindro con piston estandar para moto Suzuki AX-100</a></h2>
    									                                <h3 class="product-sku">REF: <span>DH-18K 49</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$150.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$100.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="374">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto modelo: BOXER" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2532.png" alt="Cilindro con piston estandar para moto modelo: BOXER"></a>
								                                    <div class="product-shop">
									                                   <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: BOXER">Cilindro con piston estandar para moto modelo: BOXER</a></h2>
									                                    <h3 class="product-sku">REF: <span>DH-18K 50</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$130.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$100.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="375">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                                							    <span><span>Comprar</span></span></button>
                                                							    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
							                            ...
							                            <ul class="products-grid row odd">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto modelo: CD-100, C-100 WAV, ECO DELUXE,ECO-100" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2533.png" alt="Cilindro con piston estandar para moto modelo: CD-100, C-100 WAV, ECO DELUXE,ECO-100"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: CD-100, C-100 WAV, ECO DELUXE,ECO-100">Cilindro estandar para moto: CD-100, C-100 WAV, ECO-100</a></h2>
									                                    <h3 class="product-sku">REF: <span>DH-18K 51</span></h3>
									                                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$100.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$80.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="376">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												                            </form>        
                                            								<span><span>Comprar</span></span></button>
						                                    ...
						                                    <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto modelo: AKT-150" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2534.png" alt="Cilindro con piston estandar para moto modelo: AKT-150"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: AKT-150">Cilindro con piston estandar para moto modelo: AKT-150</a></h2>
    									                                <h3 class="product-sku">REF: <span>DH-18K 52</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$130.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$90.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="377">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
						                                    ...
						                                    <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Cilindro con piston estandar para moto modelo: AKT-150" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/cilindros/cil2535.png" alt="Cilindro con piston estandar para moto modelo: AKT-150"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Cilindro con piston estandar para moto modelo: AKT-150">Cilindro con piston estandar para moto modelo: AKT-150</a></h2>
									                                    <h3 class="product-sku">REF: <span>DH-18K 53</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$130.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$90.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="378">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
