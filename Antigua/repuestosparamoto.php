...
<?php include'Shikamaru.php';
	...
	if (isset($_POST['idmoto'])) //Agreando  productos al carro
		{
			$item=$_POST['idmoto'];
		//	$productos=$shika->getListaProductos($idmoto);
			$productos=$shika->getListaProductos($item);
			//echo("La moto elegida fue: ");
			//echo $item;
	...
	//$productos=$shika->getListaProductos(57);
?><html>
...
<link rel="stylesheet" href="thecss/ventanaemergente/browse.css" type="text/css"> 
    ...
    color:#0000FF;">
			...
			<!--		<div class="navtrail" style="background-color:red;">
					...
					<?php include 'centralrepuestosparamoto.php';?>
