...
?><html>
	...
	function sendform(){
	    ...
	    var telefono='';
	    var mensaje='';
	    input2=$(".formcontact input");
	    //var("jz"+input2[0].value);
	    nombre=input2[0].value;
	    apellido=input2[1].value;
	    correo=input2[2].value;
	    telefono=input2[3].value;
...
<link rel="stylesheet" href="thecss/ventanaemergente/browse.css" type="text/css"> 
    ...
    color:#0000FF;">
			...
			<!--		<div class="navtrail" style="background-color:red;">
					...
					<?php include 'centralcontacto.php';?>
