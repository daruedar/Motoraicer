									    ...
									    <div class="padding-s">
									        <div class="breadcrumbs">
    													<ul>
    														...
    														<li class="category54"><a href="" title="">Pistones</a><span>&gt;</span></li>
    														<!--<li class="category69"><strong>USB Microscopes</strong></li>-->
    													</ul>
												    </div>
											<div class="page-title category-title"><h1>PISTONES</h1></div>
												    <div class="category-products">
							                            <ul class="products-grid row first odd">
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Piston estandar para moto Suzuki modelo:AX-100" class="product-image">
											                            <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2585.png" alt="Piston estandar para moto Suzuki modelo:AX-100">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Piston estandar para moto Suzuki modelo:AX-100">
												                            Piston estandar para moto Suzuki modelo:AX-100</a></h2>
												    
											                            <h3 class="product-sku">REF: <span>DR-86K 45</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
												                            ...
												                            <p class="special-price">
													                            ...
													                            <span class="price" id="product-price-1802">30.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
											                                 <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="397">
								                            ...
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Piston estandar para moto:BOXER" class="product-image">
											                             <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2586.png" alt="Piston estandar para moto:BOXER">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Piston estandar para moto:BOXER">
												                             Piston estandar para moto:BOXER</a></h2>
											                            <h3 class="product-sku">REF: <span>DR-86K 46</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$60.000</span>
											                            ...
											                            <div class="actions">
											                                 <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="398">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
                                    							<div class="wrapper-hover">
                                    								<a href="" title="Piston estandar para moto:CD-100 y C-100" class="product-image">
                                    								    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2587.png" alt="Piston estandar para moto:CD-100 y C-100"></a>
                                    								<div class="product-shop">
                                    									<h2 class="product-name"><a href="" title="Piston estandar para moto:CD-100 y C-100">Piston estandar para moto:CD-100 y C-100</a></h2>
                                    									<h3 class="product-sku">REF: <span>DR-86K 47</span></h3>
                                    				                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            							     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="399">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row even">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto:AKT-150" class="product-image">
								                                    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2588.png" alt="Piston estandar para moto:AKT-150"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Piston estandar para moto:AKT-150">Piston estandar para moto:AKT-150</a></h2>
									                                    <h3 class="product-sku">REF: <span>DR-86K 48</span></h3>
									                                     <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            							     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="400">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto:GN-150" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2589.png" alt="Piston estandar para moto:GN-125"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Piston estandar para moto:GN-125">Piston estandar para moto:GN-125</a></h2>
    									                                <h3 class="product-sku">REF: <span>DR-86K 49</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                						     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="401">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto:CBF-150" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2590.png" alt="Piston estandar para moto:CBF-150"></a>
								                                    <div class="product-shop">
									                                   <h2 class="product-name"><a href="" title="Piston estandar para moto:CBF-150">Piston estandar para moto:CBF-150</a></h2>
									                                    <h3 class="product-sku">REF: <span>DR-86K 50</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                						     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="402">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row odd">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto : DISCOVER 135" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2591.png" alt="Piston estandar para moto : DISCOVER 135"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Piston estandar para moto : DISCOVER 135">Piston estandar para moto : DISCOVER 135</a></h2>
									                                    <h3 class="product-sku">REF: <span>DR-86K 51</span></h3>
									                                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								<button type="button" title="Add to Cart" class="button btn-cart" onclick="location.href = 'http://www.motoraicer.com/micro/compras.php?motorepuesto=403&repuestodemoto=<?php echo($t); ?>'; "><span><span>Comprar</span></span></button>
                                            								<button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
                                            							</div>
								                                    </div>
													                <div class="label-product"> </div>            
						                                    ...
						                                    <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto :LIBERO YD-110" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2592.png" alt="Piston estandar para moto :LIBERO YD-110"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Piston estandar para moto :LIBERO YD-110">Piston estandar para moto :LIBERO YD-110</a></h2>
    									                                <h3 class="product-sku">REF: <span>DR-86K 52</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                						     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="404">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
						                                    ...
						                                    <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Piston estandar para moto :PULSAR-180" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/pistones/pis2593.png" alt="Piston estandar para moto :PULSAR-180"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Piston estandar para moto :PULSAR-180">Piston estandar para moto :PULSAR-180</a></h2>
									                                    <h3 class="product-sku">REF: <span>DR-86K 53</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$60.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$30.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                						     <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="405">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
