			...
			<div class="header">
				...
				<div class="quick-access">
					<ul class="links">
                        ...
                        <li class="top-car"><a href="" title="Mi carro" class="top-link-cart"><span style="font-size:22px;">Mi Carro</span></a></li>
                ...
                <h1 class="logo"><strong>Moto repuestos</strong>
					<a href="" title="repuestos para moto motoraicer" class="logo"><img src="../../micro/imagenes/loboc.jpg" alt="Logo Motoraicer"></a>
				</h1>
                <div class="clear">
