...
<body class="ps-static  cms-index-index cms-home" style="position: relative; min-height: 100%; top: 0px;">   
	...
	<!-- Baner  new  -->			<div class="col-main col-xs-12 col-sm-9">
									    <div class="padding-s">
											...
											<div class="page-title category-title"><h1>MOTORES DE ARRANQUE</h1></div>
												    <div class="category-products">
							                            <ul class="products-grid row first odd">
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Motor de arranque para motos modelo:AKT-200 SM" class="product-image">
											                            <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2505.png" alt="Motor de arranque para motos modelo:AKT-200 SM">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:AKT-200 SM">
												                            Motor de arranque para motos modelo:AKT-200 SM</a></h2>
												    
											                            <h3 class="product-sku">REF: <span>CMH-18K 45</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
											                            ...
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="406">
								                            ...
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Motor de arranque para motos modelo:AKT-110/125 FLEX" class="product-image">
											                             <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2506.png" alt="Motor de arranque para motos modelo:AKT-110/125 FLEX">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:AKT-110/125 FLEX">
												                             Motor de arranque para motos modelo:AKT-110/125 FLEX</a></h2>
											                            <h3 class="product-sku">REF: <span>CMH-18K 46</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$90.000</span>
											                            ...
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="407">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
                                    							<div class="wrapper-hover">
                                    								<a href="" title="Motor de arranque para motos modelo:AKT-125/150 AKT-EVO" class="product-image">
                                    								    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2507.png" alt="Motor de arranque para motos modelo:AKT-125/150 AKT-EVO"></a>
                                    								<div class="product-shop">
                                    									<h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:AKT-125/150 AKT-EVO">Motor de arranque para motos modelo:AKT-125/150 AKT-EVO</a></h2>
                                    									<h3 class="product-sku">REF: <span>CMH-18K 47</span></h3>
                                    				                    <div class="price-box">
                                            							...
                                            							<div class="actions">
                                            							    <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="408">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row even">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Motor de arranque para motos modelo:GN-125 GS-125 DR-200" class="product-image">
								                                    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2508.png" alt="Motor de arranque para motos modelo:GN-125 GS-125 DR-200"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:GN-125 GS-125 DR-200">Motor de arranque para motos modelo:GN-125 GS-125 DR-200</a></h2>
									                                    <h3 class="product-sku">REF: <span>CMH-18K 48</span></h3>
									                                     <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$60.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="409">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                            								    <span><span>Comprar</span></span></button>
                                            								    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
												            ...
												            <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Motor de arranque para motos modelo:PULSAR 180 UG" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2510.png" alt="Motor de arranque para motos modelo:PULSAR 180 UG"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:PULSAR 180 UG">Motor de arranque para motos modelo:PULSAR 180 UG</a></h2>
    									                                <h3 class="product-sku">REF: <span>BMH-18K 49</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$60.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="410">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Motor de arranque para motos modelo:CRYPTON 115" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2511.png" alt="Motor de arranque para motos modelo:CRYPTON 115"></a>
								                                    <div class="product-shop">
									                                   <h2 class="product-name"><a href="" title="Motor de arranque para motos modelo:CRYPTON 115">Motor de arranque para motos modelo:CRYPTON 115</a></h2>
									                                    <h3 class="product-sku">REF: <span>CMH-18K 50</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$60.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="411">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                                							    <span><span>Comprar</span></span></button>
                                                							    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
							                            ...
							                            <ul class="products-grid row odd">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Motor de arranque para motos:PULSAR 135 PLATINO 125 DISCOVER 100" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot2509.png" alt="Motor de arranque para motos:PULSAR 135 PLATINO 125 DISCOVER 100"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Motor de arranque para motos:PULSAR 135 PLATINO 125 DISCOVER 100">
									                                        Motor de arranque para motos:PULSAR 135 PLATINO 125 DISCOVER 100</a></h2>
									                                    <h3 class="product-sku">REF: <span>CMH-18K 51</span></h3>
									                                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$60.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="412">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												                            </form>        
                                            								<span><span>Comprar</span></span></button>
						                                    ...
						                                    <!--<li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Bujia larga de 10mm  para motos modelo:GN-125 y PULSAR" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot25050.png" alt="Bujia larga de 10mm  para motos modelo:GN-125 y PULSAR"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Bujia larga de 10mm  para motos modelo:GN-125 y PULSAR">Bujia larga de 10mm  para motos modelo:GN-125 y PULSAR</a></h2>
    									                                <h3 class="product-sku">REF: <span>BMH-18K 52</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$15.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$12.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="311">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
						                                    ...
						                                    <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Bujia corta de 10mm  para motos modelo:V-80 y FR-80" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/motorarranque/mot25050.png" alt="Bujia corta de 10mm  para motos modelo:V-80 y FR-80"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Bujia corta de 10mm  para motos modelo:V-80 y FR-80">Bujia corta de 10mm  para motos modelo:V-80 y FR-80</a></h2>
									                                    <h3 class="product-sku">REF: <span>BMH-18K 53</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$15.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$12.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="312">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
				                                        ...
				                                        <div class="toolbar-bottom">
					                                        <div class="toolbar">
					                                            <div class="pager">
					                                                <p class="amount"><strong>7 Item(s)</strong></p>
					                                            </div>
	                                                            <div class="sorter">
							                                        <p class="view-mode"></p>
					                                            </div>
