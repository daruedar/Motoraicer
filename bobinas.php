...
<body class="ps-static  cms-index-index cms-home" style="position: relative; min-height: 100%; top: 0px;">   
	...
	<!-- Baner  new  -->			<div class="col-main col-xs-12 col-sm-9">
									    <div class="padding-s">
											...
											<div class="page-title category-title"><h1>BOBINAS</h1></div>
												    <div class="category-products">
							                            <ul class="products-grid row first odd">
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Bobina de alta para moto Boxer CT" class="product-image">
											                            <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2570.png" alt="Bobina de alta para moto Boxer CT">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Bobina de alta para moto Boxer CT">
												                            Bobina de alta para motos modelo Boxer CT</a></h2>
												    
											                            <h3 class="product-sku">REF: <span>AMH-18K 45</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$30.000</span>
												                            </p>

												                            <p class="special-price">
													                            <span class="price-label">Precio Especial</span>
													                            <span class="price" id="product-price-1802">$20.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="261">
								                            ...
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Bobina de alta para motos modelo ECO-100" class="product-image">
											                             <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2571.png" alt="Bobina de alta para motos modelo ECO-100">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Bobina de alta para motos modelo ECO-100">
												                             Bobina de alta para motos modelo ECO-100</a></h2>
											                            <h3 class="product-sku">REF: <span>AMH-18K 46</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$30.000</span>
											                            ...
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="262">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
                                    							<div class="wrapper-hover">
                                    								<a href="" title="Bobina de alta para motos modelo Pulsar Black" class="product-image">
                                    								    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2572.png" alt="Bobina de alta para motos modelo Pulsar Black"></a>
                                    								<div class="product-shop">
                                    									<h2 class="product-name"><a href="" title="Bobina de alta para motos modelo Pulsar Black">Bobina de alta para motos modelo Pulsar Black</a></h2>
                                    									<h3 class="product-sku">REF: <span>AMH-18K 47</span></h3>
                                    				                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            							    <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="263">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row even">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Bobina de alta para motos modelo CB-110" class="product-image">
								                                    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2573.png" alt="Bobina de alta para motos modelo CB-110"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Bobina de alta para motos modelo CB-110">Bobina de alta para motos modelo CB-110</a></h2>
									                                    <h3 class="product-sku">REF: <span>AMH-18K 48</span></h3>
									                                     <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="264">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                            								    <span><span>Comprar</span></span></button>
                                            								    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
												            ...
												            <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Bobina de alta para motos modelo  FZ-50/FR-80" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2531.png" alt="Bobina de alta para motos modelo  FZ-50/FR-80"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Bobina de alta para motos modelo  FZ-50/FR-80">Bobina de alta para motos modelo  FZ-50/FR-80</a></h2>
    									                                <h3 class="product-sku">REF: <span>AMH-18K 49</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="265">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Bobina de Alta para motos modelo AX 100" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2532.png" alt="Bobina de Alta para motos modelo AX 100"></a>
								                                    <div class="product-shop">
									                                   <h2 class="product-name"><a href="" title="Bobina de Alta para motos modelo AX 100">Bobina de Alta para motos modelo AX 100</a></h2>
									                                    <h3 class="product-sku">REF: <span>AMH-18K 50</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="266">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                                							    <span><span>Comprar</span></span></button>
                                                							    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
							                            ...
							                            <ul class="products-grid row odd">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Bobina de alta para motos modelo RX-100  RX-115 RX-125 RX-135" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2533.png" alt="Bobina de alta para motos modelo RX-100  RX-115 RX-125 RX-135"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Bobina de alta para motos modelo RX-100  RX-115 RX-125 RX-135">
									                                        Bobina de alta para motos RX-100  RX-115 RX-125 RX-135</a></h2>
									                                    <h3 class="product-sku">REF: <span>AMH-18K 51</span></h3>
									                                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="267">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												                            </form>        
                                            								<span><span>Comprar</span></span></button>
						                                    ...
						                                    <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Bobina de alta para motos modelo CG-125" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2513.png" alt="Bobina de alta para motos modelo CG-125"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Bobina de alta para motos modelo CG-125">Bobina de alta para motos modelo CG-125</a></h2>
    									                                <h3 class="product-sku">REF: <span>AMH-18K 52</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$30.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$20.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="268">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
						                                    ...
						                                    <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Bobinas de encendido para motos modelo GN-125" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/bobinas/bob2517.png" alt="Bobinas de encendido para motos modelo GN-125"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Bobinas de encendido para motos modelo GN-125">Bobinas de encendido para motos modelo GN-125</a></h2>
									                                    <h3 class="product-sku">REF: <span>AMH-18K 53</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$70.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$50.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="269">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
