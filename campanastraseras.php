									    ...
									    <div class="padding-s">
									        <div class="breadcrumbs">
    													<ul>
    														...
    														<li class="category54"><a href="" title="">campanas traseras</a><span>&gt;</span></li>
    														<!--<li class="category69"><strong>USB Microscopes</strong></li>-->
    													</ul>
												    </div>
											<div class="page-title category-title"><h1>CAMPANAS TRASERAS</h1></div>
												    <div class="category-products">
							                            <ul class="products-grid row first odd">
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Campana trasera para moto modelo:LIBERO 110 y RX-100" class="product-image">
											                            <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2661.png" alt="Campana trasera para moto modelo:LIBERO 110 y RX-100">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Campana trasera para moto modelo:LIBERO 110 y RX-100">
												                            Campana trasera para moto modelo:LIBERO 110 y RX-100</a></h2>
												    
											                            <h3 class="product-sku">REF: <span>LH-18K 45</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
													                            <span class="price" id="old-price-1802">$90.000</span>
												                            </p>

												                            <p class="special-price">
													                            <span class="price-label">Precio Especial</span>
													                            <span class="price" id="product-price-1802">$70.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
											                                <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="343">
								                            ...
								                            <li class="item first col-xs-12 col-sm-4">
									                            <div class="wrapper-hover">
										                            <a href="" title="Campana trasera para moto modelo:BOXER y G7" class="product-image">
											                             <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2662.png" alt="Campana trasera para moto modelo:BOXER y G7">
										                            </a>
										                            <div class="product-shop">
											                            <h2 class="product-name"><a href="" title="Campana trasera para moto modelo:BOXER y G7">
												                             Campana trasera para moto modelo:BOXER y G7</a></h2>
											                            <h3 class="product-sku">REF: <span>LH-18K 46</span></h3>
											                            <div class="price-box">
												                            <p class="old-price">
													                            <span class="price-label">Precio Regular:</span>
												                            ...
												                            <p class="special-price">
													                            <span class="price-label">Precio Especial</span>
													                            <span class="price" id="product-price-1802">$50.000</span>
												                            </p>
											                            </div>				
											                            <div class="actions">
												                            <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="335">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												                                <span><span>Comprar</span></span></button>
												            ...
												            <li class="item last col-xs-12 col-sm-4">
                                    							<div class="wrapper-hover">
                                    								<a href="" title="Campana trasera para moto modelo:BOXER y G7" class="product-image">
                                    								    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2663.png" alt="Campana trasera para moto modelo:BOXER y G7"></a>
                                    								<div class="product-shop">
                                    									<h2 class="product-name"><a href="" title="Campana trasera para moto modelo:BOXER y G7">Campana trasera con sello buje y Balinera:BOXER y G7</a></h2>
                                    									<h3 class="product-sku">REF: <span>LH-18K 47</span></h3>
                                    				                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$80.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$55.000</span></p>
                                    					                </div>
                                            							<div class="actions">
                                            							    <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="345">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
							                            ...
							                            <ul class="products-grid row even">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Campana trasera para moto modelo:DTK-125 y XTZ-125 4H" class="product-image">
								                                    <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2520.png" alt="Campana trasera para moto modelo:DTK-125 y XTZ-125 4H"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Campana trasera para moto modelo:DTK-125 y XTZ-125 4H">Campana trasera para moto modelo:DTK-125 y XTZ-125 4H</a></h2>
									                                    <h3 class="product-sku">REF: <span>LH-18K 48</span></h3>
									                                     <div class="price-box">
                                            							...
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="346">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                            								    <span><span>Comprar</span></span></button>
                                            								    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
												            ...
												            <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Campana trasera para moto modelo:TS-125 CR" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2521.png" alt="Campana trasera para moto modelo:TS-125 CR"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Campana trasera para moto modelo:TS-125 CR">Campana trasera para moto modelo:TS-125 CR</a></h2>
    									                                <h3 class="product-sku">REF: <span>LH-18K 49</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$120.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$90.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                						    <form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="347">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
												            ...
												            <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Campana trasera para moto modelo:DTK-125 y XTZ-125 " class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2522.png" alt="Campana trasera para moto modelo:DTK-125 y XTZ-125"></a>
								                                    <div class="product-shop">
									                                   <h2 class="product-name"><a href="" title="Campana trasera para moto modelo:DTK-125 y XTZ-125">Campana trasera para moto modelo:DTK-125 y XTZ-125</a></h2>
									                                    <h3 class="product-sku">REF: <span>LH-18K 50</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$120.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$90.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="348">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                                							    <span><span>Comprar</span></span></button>
                                                							    <button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
							                            ...
							                            <ul class="products-grid row odd">
								                            <li class="item first col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Campana Trasera para moto  RX-100, V-80 y CRYPTON" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2539.png" alt="Campana Trasera para moto  RX-100, V-80 y CRYPTON"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Campana Trasera para moto  RX-100, V-80 y CRYPTON">Campana Trasera para moto  RX-100, V-80 y CRYPTON</a></h2>
									                                    <h3 class="product-sku">REF: <span>LH-18K 51</span></h3>
									                                    <div class="price-box">
                                    								        <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$80.000 </span></p>
                                            							...
                                            							<div class="actions">
                                            								...
                                            								<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="349">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                            								<span><span>Comprar</span></span></button>
                                            								<button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
						                                    ...
						                                    <li class="item col-xs-12 col-sm-4">
						                                    	<div class="wrapper-hover">
								                                    <a href="" title="Campana Trasera para moto modelo RX-110 y LIBERO" class="product-image">
								                                         <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2543.png" alt="Campana Traseras para motos modelo RX-110,LIBERO"></a>
    								                                <div class="product-shop">
    									                                <h2 class="product-name"><a href="" title="Campana Trasera para moto modelo RX-110 y LIBERO">Campana Trasera para moto modelo RX-110,LIBERO</a></h2>
    									                                <h3 class="product-sku">REF: <span>LH-18K 52</span></h3>
    									                                <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$80.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="351">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
                                                							<span><span>Comprar</span></span></button>
                                                							<button type="button" title="Details" class="button btn-details" onclick="setLocation('')"><span><span>Details</span></span></button>
						                                    ...
						                                    <li class="item last col-xs-12 col-sm-4">
							                                    <div class="wrapper-hover">
								                                    <a href="" title="Campana Trasera para moto modelo AKT-125" class="product-image">
								                                        <img src="http://www.motoraicer.com/micro/imagenes/repuestosparamoto/campanastraseras/cam2541.png" alt="Campana Trasera para moto modelo AKT-125"></a>
								                                    <div class="product-shop">
									                                    <h2 class="product-name"><a href="" title="Campana Trasera para moto modelo AKT-125">Campana Trasera para moto modelo AKT-125</a></h2>
									                                    <h3 class="product-sku">REF: <span>LH-18K 53</span></h3>
									                                    <div class="price-box">
                                        								    <p class="old-price"><span class="price-label">Precio Regular:</span><span class="price" id="old-price-3030">$90.000 </span></p>
                                                                            <p class="special-price"><span class="price-label">Precio Especial:</span><span class="price" id="product-price-3030">$80.000</span></p>
                                        					           </div>
                                                						<div class="actions">
                                                							...
                                                							<form class="form7" method="post" action="micro/compras.php">
											                                    <input class="total" type="hidden" name="motorepuesto" value="350">
											                                    <input class="total" type="hidden" name="repuestodemoto" value="<?php echo($t); ?>">
												                                <button type="submit" title="Agregar al carro" class="button btn-cart">
