...
<div class="std">
							...
							<div class="container">
							    <div clas="row"> <div class="col-lg-12 col-md-12 col-xs-12"><h2>Pago en efectivo</h2>   </div></div>
							    <div class="row">
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/wp-content/uploads/2017/03/efecty-1.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/wp-content/uploads/2017/03/sured.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/wp-content/uploads/2017/03/viabaloto.png" class="img-responsive"></div>
							    </div>
							</div>
							

							<div class="container">
							    <div clas="row"> <div class="col-lg-12 col-md-12 col-xs-12">	<h2>Tarjeta de Credito</h2>   </div></div>
							    <div class="row">
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/03/visa.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/03/mastercard.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/02/american_express.png" class="img-responsive"></div>
							    </div>
	        	...
	        	<div class="container">
	        	    	           <div clas="row"> <div class="col-lg-12 col-md-12 col-xs-12">	<h2>Pago en Bancos</h2>   </div></div>
							    <div class="row">
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/02/bancolombia.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/03/davivienda.png" class="img-responsive"></div>
							        <div class="col-lg-4 col-md-5 col-xs-12">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/02/bancobog-1.png" class="img-responsive"></div>
							    </div>
	        	...
	        	<div class="container">
	        	    <div clas="row"> <div class="col-lg-12 col-md-12 col-xs-12"><h2>Transferencia Bancaria<br></h2>	   </div></div>
							    <div class="row">
							        <div class="col-lg-4 col-md-5 col-sm-6">	<img src="https://www.payulatam.com/co/wp-content/uploads/sites/2/2017/04/PSE.png" class="img-responsive"></div>
