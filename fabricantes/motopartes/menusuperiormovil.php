<!--Visible solo en los dispositivos moviles-->
 ...
 <div class="swipe-menu">
  <a href="../../index.php" title="Home" class="home-link">Inicio</a>
    <ul class="links">
     ...
     <li class="top-car"><a href="../../micro/compras.php" title="Mi lista de compras" class="top-link-cart">Mi Carro</a></li>
	...
	<div class="footer-links-menu">   
	 <ul class="links-2">
	  <li class="first"><a href="../../contactenos.php">Info Asesores</a></li>
